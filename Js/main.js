// Product Card
import { products ,createProductCards } from "./data.js";
if (document.getElementById("products-container")|| document.getElementById("prodetails") ) {
  createProductCards(products);
} 

// Light & Dark Theme
// let themeCon = document.querySelector(".themeicon");
...
//   if (istheme === 1) {
//     // Light Theme
//     theme.classList.remove("fa-regular", "fa-moon");
...
//     theme.classList.add("fa-regular", "fa-moon");
...
let topBtn = document.querySelector(".remove");

// LocalStorage Get Navbar
...
const API_KEY = 'AIzaSyA4_3ijmxxZ2N3bzAgeM8GVxOuOTGN1vVY'; 
